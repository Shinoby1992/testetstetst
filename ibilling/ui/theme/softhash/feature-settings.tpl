        ...
        <div class="ibox float-e-margins" id="ui_settings">
            ...
            <div class="ibox-content">
                <table class="table table-hover">
                    ...
                    <tr>
                        <td width="80%"><label for="config_accounting">{$_L['Enable Accounting']} </label></td>
                    ...
                    <tr>
                        <td width="80%"><label for="config_invoicing">{$_L['Enable Invoicing']} </label></td>
                    ...
                    <tr>
                        <td width="80%"><label for="config_quotes">{$_L['Enable Quotes']} </label></td>
