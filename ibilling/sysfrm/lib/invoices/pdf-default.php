...
<div id="page-wrap">
    ...
    <table width="100%">
        <tr>
            ...
            <td style="border: 0;  text-align: right" width="62%"><div id="logo">
                    <img id="image" src="<?php echo APP_URL; ?>/sysfrm/uploads/system/logo-md.png" alt="logo" /> <br>
    ...
    <table id="items" <?php if(($d['status']) == 'Paid'){ echo 'background="'.APP_URL.'/sysfrm/lib/invoices/images/paid.png" style="background-repeat:no-repeat;"'; } ?> >
