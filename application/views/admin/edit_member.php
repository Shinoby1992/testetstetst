...
<div class="form-group">
        ...
        <label for="name-in" class="col-md-3 label-heading"><?php echo lang("ctn_32") ?></label>
        <div class="col-md-9">
            <select name="user_level" class="form-control">
            <option value="-1" <?php if($member->user_level == -1) echo "selected" ?>><?php echo lang("ctn_33") ?></option>
            <option value="0" <?php if($member->user_level == 0) echo "selected" ?>><?php echo lang("ctn_34") ?></option>
            <option value="4" <?php if($member->user_level == 4) echo "selected" ?>><?php echo lang("ctn_35") ?></option>
            </select>
        </div>
</div>
<div class="form-group">
