<div class="db-header clearfix">
    ...
    <div class="db-header-extra"> <input type="button" class="btn btn-primary btn-sm" value="<?php echo lang("ctn_65") ?>" data-toggle="modal" data-target="#ipModal" />
</div>
</div>
...
<tr><td><?php echo $r->IP ?></td><td><?php echo $r->reason ?></td><td><?php echo date($this->settings->info->date_format, $r->timestamp) ?></td><td><a href="<?php echo site_url("admin/delete_ipblock/" . $r->ID) ?>" class="btn btn-danger btn-xs"><?php echo lang("ctn_57") ?></a></td></tr>
<?php endforeach; ?>
</table>
    ...
    <div class="modal-content">
      ...
      <?php echo form_open(site_url("admin/add_ipblock"), array("class" => "form-horizontal")) ?>
            <div class="form-group">
                    <label for="email-in" class="col-md-3 label-heading"><?php echo lang("ctn_68") ?></label>
                    <div class="col-md-9">
            ...
            <div class="form-group">
                        ...
                        <label for="username-in" class="col-md-3 label-heading"><?php echo lang("ctn_72") ?></label>
                        <div class="col-md-9">
