      ...
      <?php echo form_open(site_url("admin/add_member_pro"), array("class" => "form-horizontal")) ?>
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                        ...
                        <label for="name-in" class="col-md-3 label-heading"><?php echo lang("ctn_82") ?></label>
                        <div class="col-md-9">
                            <select name="user_level" class="form-control">
                            <option value="0"><?php echo lang("ctn_34") ?></option>
                            <option value="4"><?php echo lang("ctn_35") ?></option>
                            </select>
                        </div>
                </div>
